...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('donation', function (Blueprint $table) {
            $table->foreign(['request_id'], 'donation_request_id_fkey')->references(['request_id'])->on('donation_request')->onUpdate('no action')->onDelete('no action');
    ...
    {
        Schema::table('donation', function (Blueprint $table) {
            $table->dropForeign('donation_request_id_fkey');
