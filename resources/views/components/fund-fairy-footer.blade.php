    ...
    <div class="max-w-6xl mx-auto px-5">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center text-center md:text-left md:items-start">
            ...
            <div class="flex space-x-6 mt-6 md:mt-0 order-2 md:order-1">
                <a href="https://twitter.com/yourprofile" target="_blank" class="text-gray-400 hover:text-white text-2xl">
                    <i class="fa-brands fa-x-twitter"></i>
                </a>
                <a href="https://www.facebook.com/profile.php?id=61574036584417" target="_blank" class="text-gray-400 hover:text-white text-2xl">
                    <i class="fa-brands fa-facebook-f"></i>
                </a>
                <a href="http://www.tiktok.com/@fundfairyia" target="_blank" class="text-gray-400 hover:text-white text-2xl">
            ...
            <div class="order-1 md:order-2 mb-6 md:mb-0">
                ...
                <p class="text-gray-300">We are strong together.</p>
            </div>
...
{{--        <!-- Footer Links -->--}}
{{--        <div class="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between text-sm text-gray-400">--}}
{{--            <p>&copy; FundFairy, 2025. All rights reserved.</p>--}}
