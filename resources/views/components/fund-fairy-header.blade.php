<header class="bg-fuchsia-950 text-white p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            ...
            <x-fund-fairy-nav-link :actihover:text-white no-underline hover:no-underlineve="request()->is('businesses')" url="/businesses">Businesses</x-fund-fairy-nav-link>
            ...
            <x-fund-fairy-button-link btnColor="bg-yellow-500" textClass="text-white font-bold" url="/donation/create" icon="edit" :block="true">Donation Request</x-fund-fairy-button-link>
        </nav>
